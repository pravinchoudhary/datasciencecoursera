...
## Step 3: y_combinedPutting descriptive activity names to name the activities in the data set
y_combined <- factor(y_combined[, "activity"], labels = c("WALKING", "WALKING_UPSTAIRS", "WALKING_DOWNSTAIRS", "SITTING", "STANDING", "LAYING"))
...
tidy_data <- group_by(data_combined, subject)
